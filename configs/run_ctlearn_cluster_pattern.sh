...
#SBATCH -t 02:30:00               # Tiempo máximo de ejecución (hh:mm:ss)
#SBATCH -A gpu
...
ctlearn -d TRN -i "/fefs/aswg/workspace/tjark.miener/DeepCrab/R1DL1/LSTProd2/TrainingDataset/GammaDiffuse/dec_2276/theta_16.087_az_108.090/" "/fefs/aswg/workspace/tjark.miener/DeepCrab/R1DL1/LSTProd2/TrainingDataset/Protons/dec_2276/theta_16.087_az_108.090/" --pattern "gamma_*_runs123-182*" "proton_*_runs1001-1125*" -o "/home/olmo.arqueropeinazo/data/temp/logs/trial_pattern/" -z 50 -e 15 -t LST_LST_LSTCam -b 24 -r type
