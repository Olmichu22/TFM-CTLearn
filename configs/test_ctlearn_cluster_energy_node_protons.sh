...
#SBATCH -o slurm_outputs/test/result_test_energy_%j.out          # Archivo de salida (stdout)
#SBATCH --error=slurm_outputs/test/result_test_energy_%j.err     # Archivo de errores (stderr)
#SBATCH -A gpu
...
ctlearn \
 -d TRN \
 --config_file "/fefs/home/olmo.arqueropeinazo/TFM/TFM-CTLearn/logs/trial_complete_data_energy_node/20240722_111350_config.yml" \
 -o "/fefs/home/olmo.arqueropeinazo/TFM/TFM-CTLearn/logs/trial_complete_data_energy_node/" \
 -t LST_LST_LSTCam \
 -b 64 \
 --clean \
 --log_to_file \
