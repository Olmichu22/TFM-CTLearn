...
ctlearn -d TRN -i /fefs/aswg/workspace/tjark.miener/DeepCrab_new/DL1/LSTProd2/TrainingDataset/GammasDiffuse/ -p "*16.087_az_108.090*" -o "/fefs/home/olmo.arqueropeinazo/TFM/TFM-CTLearn/logs/trial_complete_data_direction_node/" -z 50 -e 8 -t LST_LST_LSTCam -b 64 --clean --log_to_file -r direction
