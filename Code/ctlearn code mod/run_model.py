...
# Cambios para PC. Se añade la opción to_pc_options a KerasBatchGenerator
...
def run_model(config, mode="train", debug=False, log_to_file=False):
    ...
    to_pc_options = config["Input"].get("to_pc_options", dict({"point_cloud": False}))
    if mode == "train":
